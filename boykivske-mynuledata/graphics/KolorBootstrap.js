...
function eventKrpanoLoaded (isWebVr) {
	...
	ktools.I18N.getInstance().initLanguage(tourLanguage, crossDomainTargetUrl+'boykivske-mynuledata/boykivske-mynule_messages_','.xml');
	krpanoLoaded = true;
...
addKolorBox('gallery53');
addKolorBox('gallery52');
addKolorBox('gallery51');
addKolorBox('gallery50');
addKolorBox('gallery49');
addKolorBox('gallery48');
addKolorBox('gallery47');
addKolorBox('gallery46');
addKolorBox('gallery45');
addKolorBox('gallery44');
addKolorBox('gallery43');
addKolorBox('gallery42');
addKolorBox('gallery41');
addKolorBox('gallery40');
addKolorBox('gallery39');
addKolorBox('gallery38');
addKolorBox('gallery37');
addKolorBox('gallery36');
...
deleteKolorBox('gallery36');
deleteKolorBox('gallery37');
deleteKolorBox('gallery38');
deleteKolorBox('gallery39');
deleteKolorBox('gallery40');
deleteKolorBox('gallery41');
deleteKolorBox('gallery42');
deleteKolorBox('gallery43');
deleteKolorBox('gallery44');
deleteKolorBox('gallery45');
deleteKolorBox('gallery46');
deleteKolorBox('gallery47');
deleteKolorBox('gallery48');
deleteKolorBox('gallery49');
deleteKolorBox('gallery50');
deleteKolorBox('gallery51');
deleteKolorBox('gallery52');
deleteKolorBox('gallery53');
...
function eventTourChangeLanguage (pLang) {
	...
	ktools.I18N.getInstance().initLanguage(pLang, crossDomainTargetUrl+'boykivske-mynuledata/boykivske-mynule_messages_','.xml');
}
...
function addKolorBox(pPlugID)
{
	...
	{
		var kolorBoxCSS = new ktools.CssStyle("KolorBoxCSS", crossDomainTargetUrl+"boykivske-mynuledata/graphics/KolorBox/kolorBox.css");
		var kolorBoxJS = new ktools.Script("KolorBoxJS", crossDomainTargetUrl+"boykivske-mynuledata/graphics/KolorBox/KolorBox.min.js", [], true);
...
function addKolorArea(pPlugID)
{
	if(typeof ktools.KolorPluginList.getInstance().getPlugin(pPlugID) == "undefined")
	{
		var kolorAreaCSS = new ktools.CssStyle("KolorAreaCSS", crossDomainTargetUrl+"boykivske-mynuledata/graphics/KolorArea/kolorArea.css");
		var kolorAreaJS = new ktools.Script("KolorAreaJS", crossDomainTargetUrl+"boykivske-mynuledata/graphics/KolorArea/KolorArea.min.js", [], true);
